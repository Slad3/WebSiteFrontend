...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h1> Page where I blog, update on projects, or just spill my mind on whatever I care about. And if you don't care, remember YOU CLICKED ON MY FACE! </h1>\r\n<div class=\"wholeBlog\">\r\n <h1 id=\"BigTitle\"> Bob Lawblaws Law Blog</h1>\r\n\r\n <ul style=\"\" id=\"postList\">\r\n   <a *ngFor=\"let post of posts\">\r\n     <li>\r\n       <app-post [post]=\"post\"></app-post>\r\n     </li>\r\n   </a>\r\n </ul>\r\n</div>\r\n\r\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h1>This is where I will provide a list of done or in progress progress with description, a bunch of useful images, and most likely a github link.  <br/> Currently in development.</h1>\r\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<app-post [post]=\"this.post\"></app-post>\r\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DateStruct", function() { return DateStruct; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _Content__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Content */ "./src/app/Content/Content.ts");


class DateStruct extends _Content__WEBPACK_IMPORTED_MODULE_1__["Content"] {
    constructor(message) {
        super();
        this.months = [
            "January",
...
class Image extends _Content__WEBPACK_IMPORTED_MODULE_1__["Content"] {
...
class Paragraph extends _Content__WEBPACK_IMPORTED_MODULE_1__["Content"] {
    constructor(message) {
        super();
...
class SubTitle extends _Content__WEBPACK_IMPORTED_MODULE_1__["Content"] {
    constructor(message) {
        super();
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _Content_Paragraph__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Content/Paragraph */ "./src/app/Content/Paragraph.ts");
/* harmony import */ var _Content_Image__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Content/Image */ "./src/app/Content/Image.ts");
/* harmony import */ var _Content_SubTitle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Content/SubTitle */ "./src/app/Content/SubTitle.ts");
/* harmony import */ var _Content_DateStruct__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Content/DateStruct */ "./src/app/Content/DateStruct.ts");
...
class Post {
    constructor(input) {
        ...
        input.content.forEach(cont => {
            ...
            if (cont.paragraph) {
                this.content.push(new _Content_Paragraph__WEBPACK_IMPORTED_MODULE_1__["Paragraph"](cont.paragraph));
            }
            else if (cont.image) {
                this.content.push(new _Content_Image__WEBPACK_IMPORTED_MODULE_2__["Image"](cont.image));
            }
            else if (cont.subTitle) {
                this.content.push(new _Content_SubTitle__WEBPACK_IMPORTED_MODULE_3__["SubTitle"](cont.subTitle));
            }
...
/* harmony import */ var _datascience_datascience_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./datascience/datascience.component */ "./src/app/datascience/datascience.component.ts");
...
/* harmony import */ var _reference_reference_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./reference/reference.component */ "./src/app/reference/reference.component.ts");
...
const routes = [
    ...
    { path: 'blog', component: _feed_feed_component__WEBPACK_IMPORTED_MODULE_3__["FeedComponent"] },
    { path: 'projects', component: _projects_projects_component__WEBPACK_IMPORTED_MODULE_6__["ProjectsComponent"] },
    { path: 'datascience', component: _datascience_datascience_component__WEBPACK_IMPORTED_MODULE_4__["DatascienceComponent"] },
...
let AppComponent = class AppComponent {
    constructor(http) {
        ...
        this.title = "the strangest title";
        // @ViewChild('navbar') header: ElementRef;
        this.sticky = null;
        // Making Request for getting from backend
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpRequest"]("GET", this.url + "QOTD", {
...
/* harmony import */ var _datascience_datascience_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./datascience/datascience.component */ "./src/app/datascience/datascience.component.ts");
...
/* harmony import */ var _reference_reference_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./reference/reference.component */ "./src/app/reference/reference.component.ts");
/* harmony import */ var _singlepost_singlepost_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./singlepost/singlepost.component */ "./src/app/singlepost/singlepost.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _datascience_datascience_component__WEBPACK_IMPORTED_MODULE_9__["DatascienceComponent"],
            ...
            _reference_reference_component__WEBPACK_IMPORTED_MODULE_13__["ReferenceComponent"],
            _singlepost_singlepost_component__WEBPACK_IMPORTED_MODULE_14__["SinglepostComponent"],
        ],
        imports: [
...
let DatascienceComponent = class DatascienceComponent {
    ...
    getCrimeData() {
        ...
        formData.append('end', '2020-01-01');
        this.http.post(this.url + 'loadCrimeData', formData)
            .subscribe((dat) => {
            Object(xml2js__WEBPACK_IMPORTED_MODULE_3__["parseString"])(dat, { explicitArray: false }, (error, result) => {
                data = JSON.stringify(dat);
                data = JSON.parse(data);
                console.log(data);
                console.log(data.toString());
...
DatascienceComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./datascience.component.css */ "./src/app/datascience/datascience.component.css")).default]
    })
...
/* harmony import */ var _Post__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Post */ "./src/app/Post.ts");
...
let FeedComponent = class FeedComponent {
    constructor(route, location, http) {
        this.route = route;
    ...
    updatePosts() {
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpRequest"]("GET", this.url + "blog", {
            reportProgress: false,
            responseType: "text",
        });
        this.http.request(req).subscribe((event) => {
            if (event instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpResponse"]) {
                ...
                if (typeof event.body === "string") {
                    ...
                    for (let po in received) {
                        ...
                        console.log(temp);
                        this.posts.push(new _Post__WEBPACK_IMPORTED_MODULE_5__["Post"](temp.Post));
                    }
                }
            }
        }, (error) => {
...
ReferenceComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./reference.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/reference/reference.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./reference.component.css */ "./src/app/reference/reference.component.css")).default]
    })
], ReferenceComponent);
            ...
            if (event instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpResponse"]) {
                if (typeof event.body === "string") {
                    ...
                    for (let po in received) {
                        ...
                        this.post = new _Post__WEBPACK_IMPORTED_MODULE_3__["Post"](temp.Post);
                    }
                }
            }
        }, (error) => {
...
SinglepostComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./singlepost.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/singlepost/singlepost.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./singlepost.component.css */ "./src/app/singlepost/singlepost.component.css")).default]
    })
], SinglepostComponent);
...
module.exports = __webpack_require__(/*! C:\Users\Ben\WebstormProjects\PersonalWebFrontend\src\main.ts */"./src/main.ts");
