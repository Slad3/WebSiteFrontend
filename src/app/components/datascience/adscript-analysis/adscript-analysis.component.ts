...
@Component({
  selector: 'app-adscript-analyzer',
  templateUrl: './adscript-analysis.component.html',
  styleUrls: [
    './adscript-analysis.component.css',
	...
	onSubmitUpload() {
	  if (
		...
		const response = this.request.postQuery(
		  this.form,
		  this.backendUrl + 'ArrestedDevelopmentQuery'
		);
